...
Phase 8.9 produced one authentic local 2:50.20 app-only VP8/WebM candidate at 1440 × 900 with no
audio stream, plus synchronized human-reviewed English WebVTT captions and transcript. It is not
publicly hosted or entered into Devpost. This advances C18 only to
...
| C08 | [R §4](https://datahub.devpost.com/rules)                                                              | Submission functionality matches text and video.                                                                                            | The draft and claim matrix map each product claim to the real fixture UI/repository evidence; the Phase 8.9 local candidate shows one functioning canonical flow with aligned English captions. No public video or submitted form exists.                                                                                                                    | PARTIAL                                 | Phase 8.8–8.9 / entrant  | Recheck the entrant-approved public export and every final form field against the functioning take.                                                      |
...
| C18 | [R §4](https://datahub.devpost.com/rules)                                                              | Public functioning-project video is required; the Rules say it should be under three minutes and judges need not watch beyond minute three. | One authentic continuous 2:50.20, 1440 × 900 VP8/WebM app-only fixture take exists locally with synchronized human-reviewed English captions/transcript and key-frame review. It is silent, repository-local, and not a final hosted submission video.                                                                                                       | PARTIAL — LOCAL CANDIDATE               | Phase 8.9 / entrant      | Entrant reviews the chosen export/rights and performs any public upload only under separate authorization.                                               |
...
| C20 | [R §4](https://datahub.devpost.com/rules)                                                              | Video avoids unauthorized trademarks/music/material and is English or translated.                                                           | The local candidate uses only the project UI and synthetic fixture, no music/audio or added third-party media, and human-reviewed English captions/transcript; key frames passed bounded privacy/media review. Entrant review of any chosen public export remains open.                                                                                      | PARTIAL                                 | Phase 8.9 / entrant      | Entrant performs the final rights/privacy/accessibility review and retains evidence before any authorized upload.                                        |
| C21 | [R §4](https://datahub.devpost.com/rules)                                                              | All submitted materials are English or English-translated.                                                                                  | The judge-facing draft, quickstart, matrix, script, local video captions, and transcript are English; final form and publicly hosted video remain pending.                                                                                                                                                                                                   | PARTIAL                                 | Phase 8.8–8.9 / entrant  | Run a final English/translation completeness review over every submitted field and hosted asset.                                                         |
...
6. **Video visibility:** the authentic local 2:50.20 candidate advances C18 only to
   `PARTIAL — LOCAL CANDIDATE`; it has not been uploaded. Ask `support@devpost.com` whether unlisted
   hosting qualifies if Public is not feasible; current Rules only say publicly visible. C19 stays
   `OPEN`.
...
claim-mapped screenshots, quickstart, and rehearsal material. Phase 8.9 adds one authentic local
functioning-project candidate and synchronized English review packet, advancing C18/C20 only to
`PARTIAL`. It performs no registration, submission, consent, form save, public upload, deployment,
credential entry, live provisioning, tag/Release mutation, or external artifact publication.
