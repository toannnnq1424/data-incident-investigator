...
| C10 | [R §4](https://datahub.devpost.com/rules)                                                              | Public source repository with all necessary source/assets/instructions.                                                                     | GitHub is Public at exact current main `c7abc652c23b532e90091b377490b27eadd7e084`. Historical Phase 8.4B GitHub-only evidence had Pages disabled and no GitHub Environment deployment. Separately, owner-approved external public Cloud Run now exists, built from unmerged Draft PR source `3653cf6b…`; it is not current main.                             | PASS                                    | Phase 8.4B complete     | Preserve and reverify Public access, reporting, exact-main evidence, and the separately governed external service through later work.                        |
