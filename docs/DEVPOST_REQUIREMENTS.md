...
**Deadline risk:** submissions were open at access time. Apache-2.0, Public repository access, a
testable public fixture Project URL, an owner-authorized operating window beyond judging, and a
Public YouTube functioning-project video are now evidenced. Remaining blockers include live/judge
evidence for the named DataHub integration, entering the video URL and completing the project form,
entrant eligibility attestations, and submission-specific IP/data review. No post-deadline
...
copyright check reported no issue. The URL has not been entered in a Devpost project form, and no
submission or organizer acceptance exists. C18 is `PASS`; C19 is `PARTIAL` until the exact URL is
entered in Devpost.
...
read-only investigative workflow. Phase 8.11 Devpost registration selected **Open / Wildcard** and
**Working solo**; no project form has been started, saved, or submitted.
...
| --- | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| C01 | [R §3](https://datahub.devpost.com/rules)                                                              | Entrant is age/residency/conflict eligible.                                                                                                 | Repository cannot prove personal eligibility. The user's completed registration-checkbox interaction is not a durable repository attestation of age, residence, sanctions, or conflict facts.                                                                                                                                                                | OPEN                                     | Entrant / Phase 8 final    | Entrant records an explicit durable eligibility confirmation before any project-form save or submission.                                                                                    |
| C02 | [R §4](https://datahub.devpost.com/rules), [T §5](https://info.devpost.com/legal/terms-of-service)     | Create a Devpost account, join/register, and complete required fields by the deadline.                                                      | Devpost displayed `Thanks for registering!`; the entrant joined as `Working solo` and selected `Open / Wildcard`. No project form has been started, saved, or submitted. The user's checkbox interaction is not a durable repository attestation of the underlying personal/legal facts.                                                                     | PARTIAL                                  | Phase 8.11 / entrant       | Preserve registration evidence, obtain explicit durable entrant confirmations for unresolved personal/legal facts, then complete only the actual project-form controls before the deadline. |
| C03 | [R §§3–4](https://datahub.devpost.com/rules), [T §5](https://info.devpost.com/legal/terms-of-service)  | Team/organization appoints an eligible authorized representative.                                                                           | Devpost registration records `Working solo`; no team or organization is being entered.                                                                                                                                                                                                                                                                       | NOT REQUIRED                             | Phase 8.11 / entrant       | If the entrant later changes to a team or organization, reopen this gate and record membership plus representative authority before submission.                                             |
...
| C08 | [R §4](https://datahub.devpost.com/rules)                                                              | Submission functionality matches text and video.                                                                                            | The draft and claim matrix map each product claim to the real fixture UI/repository evidence. The authentic synchronized male-voice flow is Public on YouTube with authored English captions and matches the real fixture UI; its URL has not been entered in Devpost and no project form or submission exists.                                              | PARTIAL                                  | Phase 8.8–8.11 / entrant   | Recheck every final project-form field against the Public functioning take and enter the exact verified video URL before submission.                                                        |
| C09 | [R §4](https://datahub.devpost.com/rules)                                                              | Submitted repo uses Apache 2.0 visible at top/About.                                                                                        | Released exact current main `a28e21c06ad623f1547c02a6d65fd900fa8472a4` preserves canonical Apache-2.0 licensing; exact-main CI run `30338530196` / job `90208641358` is successful and GitHub detects `Apache-2.0`.                                                                                                                                          | PASS                                     | Phase 8.4A complete        | Preserve exact license/main evidence through later work and recheck detection before submission.                                                                                            |
| C10 | [R §4](https://datahub.devpost.com/rules)                                                              | Public source repository with all necessary source/assets/instructions.                                                                     | GitHub is Public at released exact current main `a28e21c06ad623f1547c02a6d65fd900fa8472a4`, tree `e0594ddecbe9d82f30e7b3005a51cb8df9283bf8`; annotated tag `v1.0.0` and its Published/Latest Release resolve to that merge. The running Cloud Run image remains separately bound to immutable source `3653cf6b…7fa4f`.                                       | PASS                                     | Phase 8.4B / 8.10 complete | Preserve and reverify Public access, reporting, exact-main evidence, and the separately governed external service through later work.                                                       |
...
| C17 | [R §4](https://datahub.devpost.com/rules)                                                              | State intended platform and complete setup/testing instructions.                                                                            | The concise public fixture path plus Node 24 / pnpm `11.9.0` repository-local fallback are rehearsed, and the owner-authorized public operating window now extends beyond judging.                                                                                                                                                                           | PASS                                     | Phase 8.8–8.11 / operator  | Recheck the public path and repository fallback immediately before submission.                                                                                                              |
| C18 | [R §4](https://datahub.devpost.com/rules)                                                              | Public functioning-project video is required; the Rules say it should be under three minutes and judges need not watch beyond minute three. | The selected authentic continuous 2:50.20, 1440 × 900 male-voice fixture flow is Public at <https://youtu.be/D5mvMqrhyDc>. It shows the functioning project, retains the verified real video stream, and has published authored English captions.                                                                                                            | PASS                                     | Phase 8.9A–8.11 complete   | Preserve the exact Public video and captions, and reverify playback immediately before entering its URL in Devpost.                                                                         |
| C19 | [R §4](https://datahub.devpost.com/rules)                                                              | Video publicly visible on YouTube, Vimeo, or Youku.                                                                                         | The selected male-voice video is Public on YouTube at <https://youtu.be/D5mvMqrhyDc>, with authored English captions and no reported copyright-check issue. The exact URL has not been entered in a Devpost project form.                                                                                                                                    | PARTIAL                                  | Phase 8.11 / entrant       | Enter the exact verified Public URL in the project form after the unresolved entrant/legal gates are truthfully completed.                                                                  |
| C20 | [R §4](https://datahub.devpost.com/rules)                                                              | Video avoids unauthorized trademarks/music/material and is English or translated.                                                           | The Public video uses only the project UI, synthetic fixture, offline Microsoft Mark narration, and authored English captions; it has no music or added third-party visual media, and YouTube reported no copyright-check issue. Repository evidence still does not provide a durable entrant rights/IP attestation.                                         | PARTIAL                                  | Phase 8.9A–8.11 / entrant  | Obtain and retain the entrant's exact rights/privacy/accessibility confirmation for the hosted export before linking or submitting it.                                                      |
| C21 | [R §4](https://datahub.devpost.com/rules)                                                              | All submitted materials are English or English-translated.                                                                                  | The judge-facing draft, quickstart, matrix, Public male narration, and published authored captions are English. No project form has been started, so final form-wide English completeness is not yet reviewable.                                                                                                                                             | PARTIAL                                  | Phase 8.8–8.11 / entrant   | Run a final English/translation completeness review over every actual project-form field and linked asset before submission.                                                                |
| C22 | [R §4](https://datahub.devpost.com/rules)                                                              | Required form fields are complete during the Submission Period.                                                                             | Registration completed, but no project form has been started, saved, or submitted; its exact controls remain unrecorded.                                                                                                                                                                                                                                     | OPEN                                     | Entrant / Phase 8 final    | After durable confirmation of unresolved entrant/legal facts, inspect and complete only the actual required project-form controls, then verify the receipt before the deadline.             |
| C23 | [O](https://datahub.devpost.com/)                                                                      | Choose/position the project against one or more published challenges.                                                                       | Devpost registration records **Open / Wildcard**, the strongest truthful fit. **Agents That Do Real Work** remains conditional and unselected because the app performs bounded read-only investigation and no write-back.                                                                                                                                    | PASS                                     | Phase 8.11 complete        | Preserve Open / Wildcard in the project form and do not imply write-back or organizer acceptance.                                                                                           |
| C24 | [R §§3–4](https://datahub.devpost.com/rules)                                                           | Provide teammate/representative information required by the form.                                                                           | Devpost registration records `Working solo`; no teammate or organization representative applies to this entry.                                                                                                                                                                                                                                               | NOT REQUIRED                             | Phase 8.11 / entrant       | Reopen only if the entrant changes the registered entry mode before submission.                                                                                                             |
...
| C29 | [R §6](https://datahub.devpost.com/rules)                                                              | Stage 2 equal criteria: DataHub, execution, originality, usefulness, submission quality.                                                    | Strong fixture/fixed-input evidence, an MCP product vertical slice, a claim-mapped draft, and one authentic Public YouTube functioning take with authored English captions exist; live DataHub inputs/provider state can vary, authorized live MCP evidence is absent, and no project form or Devpost video link exists.                                     | PARTIAL                                  | Phase 8.2–8.11             | Use the matrix to map final evidence to all five criteria without claiming live-mode determinism or organizer-published percentages.                                                        |
...
Current matrix totals after the Phase 8.11 operating-window, registration, challenge, and hosted-video
evidence are
**7 PASS / 1 QUALIFIED PASS — OWNER-AUTHORIZED SCOPE / 13 PARTIAL / 6 OPEN / 10 NOT REQUIRED**
across 37 rows.
...
2. **Licence:** integrated exact main satisfies C09. The historical Phase 8.5 release graph has 138
   ...
   immutable deployed source `3653cf6b…7fa4f`. For the later Phase 8.10 security-patched graph, the
   ...
   `v1.0.0` release. That graph is released but not deployed. C11 is
...
3. **Public repository:** C10 is `PASS`. The repository is Public at released exact main
   `a28e21c06ad623f1547c02a6d65fd900fa8472a4`, tree
   `e0594ddecbe9d82f30e7b3005a51cb8df9283bf8`; annotated tag `v1.0.0` and the Published/Latest
   Release resolve to that merge. The running service remains bound to immutable source
   `3653cf6b…7fa4f`; later verifier/docs and merge commits are repository evidence, not
   deployed-image source. Private vulnerability reporting is enabled; preserve both Public and
   reporting states through this task.
...
5. **Form schema:** Devpost registration completed with `Working solo` and `Open / Wildcard`, but the
   project form has not been started, saved, or submitted. Its exact screenshot/cover, video-link, and
   other controls remain unrecorded. The user's checkbox interaction does not create a durable
   repository attestation for age, residence, sanctions/conflicts, ownership, IP, or other personal/
   legal facts.
6. **Video host/link:** the selected authentic 2:50.20 male-voice derivative is Public at
   <https://youtu.be/D5mvMqrhyDc>, has published authored English captions, and reported no YouTube
   copyright-check issue. C18 is `PASS`. The URL has not been entered in Devpost, so C19 remains
   `PARTIAL`; no organizer acceptance or submission is claimed.
...
8. **English/accessibility:** the draft package, offline synthetic male narration, and matching
   captions/transcript are English. Bounded synchronization, accessibility, privacy, audio, and
   media-rights evidence exists. English or translation is mandatory; captions remain a
   recommendation rather than an express Rules requirement. The entrant's chosen Rules-hosted export
   and final form still require review.
...
and selects `Open / Wildcard`. No project form has been started, saved, or submitted; the video URL
has not been entered in Devpost; no organizer acceptance, durable entrant eligibility/IP attestation,
live provisioning, or tag/Release mutation is claimed.
