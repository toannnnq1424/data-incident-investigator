...
2. **Licence:** integrated exact main satisfies C09. The exact frozen graph remains 138 declared
   ...
   remains a broader C11 caveat. C11 stays `PARTIAL`; publication/distribution remains unauthorized
   until independent QA and a legal-owner disposition review the captured evidence and remaining
   rights.
