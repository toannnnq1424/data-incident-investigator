...
| C09 | [R §4](https://datahub.devpost.com/rules)                                                              | Submitted repo uses Apache 2.0 visible at top/About.                                                                                        | Exact current main `73172b7e8e8b02ab9629019eac298b89e02895c2` preserves canonical Apache-2.0 licensing; exact-main CI run `30188091600` / job `89756253516` is successful and GitHub detects `Apache-2.0`.                                                                                                                                       | PASS                                    | Phase 8.4A complete     | Preserve exact license/main evidence through later work and recheck detection before submission.                                                               |
| C10 | [R §4](https://datahub.devpost.com/rules)                                                              | Public source repository with all necessary source/assets/instructions.                                                                     | GitHub is Public at exact current main `73172b7e8e8b02ab9629019eac298b89e02895c2`; authenticated verification preserves enabled private reporting, Draft RC state, and no deployment environment.                                                                                                                                                | PASS                                    | Phase 8.4B complete     | Preserve and reverify Public access, reporting, and exact-main evidence through later work.                                                                    |
