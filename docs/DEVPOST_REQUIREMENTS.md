...
Phase 8.9 produced one authentic 2:50.20 app-only VP8/WebM candidate at 1440 × 900 with no audio
stream, plus synchronized human-reviewed English WebVTT captions and transcript. The candidate is
publicly accessible as a repository asset on the Public GitHub feature branch and Draft PR #58. It
has not been uploaded to or made publicly visible on YouTube, Vimeo, or Youku, has not been linked or
entered in Devpost, and has not been submitted. GitHub blob/raw access does not satisfy the Rules'
video-host/link requirement. This advances C18 only to `PARTIAL — LOCAL CANDIDATE`; C19 remains
`OPEN`.
...
| C08 | [R §4](https://datahub.devpost.com/rules)                                                              | Submission functionality matches text and video.                                                                                            | The draft and claim matrix map each product claim to the real fixture UI/repository evidence; the Phase 8.9 candidate shows one functioning canonical flow with aligned English captions. It is public as a GitHub repository asset, but no Rules-compliant YouTube/Vimeo/Youku video is linked in Devpost and no form is submitted.                         | PARTIAL                                 | Phase 8.8–8.9 / entrant  | Recheck the entrant-approved Rules-hosted export and every final form field against the functioning take.                                                |
| C09 | [R §4](https://datahub.devpost.com/rules)                                                              | Submitted repo uses Apache 2.0 visible at top/About.                                                                                        | Exact current main `082d617cab203393f87d0cc3b97aff5ca2b3a3dc` preserves canonical Apache-2.0 licensing; historical exact-main CI run `30188091600` / job `89756253516` is successful and GitHub detects `Apache-2.0`.                                                                                                                                        | PASS                                    | Phase 8.4A complete      | Preserve exact license/main evidence through later work and recheck detection before submission.                                                         |
| C10 | [R §4](https://datahub.devpost.com/rules)                                                              | Public source repository with all necessary source/assets/instructions.                                                                     | GitHub is Public at exact current main `082d617cab203393f87d0cc3b97aff5ca2b3a3dc`, tree `208e80f8d7e9fbab14b93ff1af16787c48e34d92`, which integrates Phase 8.8. The running Cloud Run image remains separately bound to immutable source `3653cf6b…7fa4f`; later docs merges were not redeployed.                                                            | PASS                                    | Phase 8.4B complete      | Preserve and reverify Public access, reporting, exact-main evidence, and the separately governed external service through later work.                    |
...
| C18 | [R §4](https://datahub.devpost.com/rules)                                                              | Public functioning-project video is required; the Rules say it should be under three minutes and judges need not watch beyond minute three. | One authentic continuous 2:50.20, 1440 × 900 VP8/WebM app-only fixture take has synchronized human-reviewed English captions/transcript and key-frame review. It is silent and publicly accessible as a GitHub repository asset, but it is not hosted on YouTube/Vimeo/Youku or linked in Devpost and therefore is not a final hosted submission video.      | PARTIAL — LOCAL CANDIDATE               | Phase 8.9 / entrant      | Entrant reviews the chosen export/rights and performs the Rules-listed host upload and Devpost linking only under separate authorization.                |
...
| C20 | [R §4](https://datahub.devpost.com/rules)                                                              | Video avoids unauthorized trademarks/music/material and is English or translated.                                                           | The candidate uses only the project UI and synthetic fixture, no music/audio or added third-party media, and human-reviewed English captions/transcript; key frames passed bounded privacy/media review. Entrant review of any chosen Rules-hosted export remains open.                                                                                      | PARTIAL                                 | Phase 8.9 / entrant      | Entrant performs the final rights/privacy/accessibility review and retains evidence before any authorized YouTube/Vimeo/Youku upload.                    |
| C21 | [R §4](https://datahub.devpost.com/rules)                                                              | All submitted materials are English or English-translated.                                                                                  | The judge-facing draft, quickstart, matrix, script, video captions, and transcript are English; the final form and a Rules-listed hosted-and-linked video remain pending.                                                                                                                                                                                    | PARTIAL                                 | Phase 8.8–8.9 / entrant  | Run a final English/translation completeness review over every submitted field and hosted asset.                                                         |
...
Current matrix totals during Phase 8.9 local-candidate preparation are
...
3. **Public repository:** C10 is `PASS`. The repository is Public, exact main is
   ...
   `208e80f8d7e9fbab14b93ff1af16787c48e34d92`, and Phase 8.8 is integrated. The running service
...
6. **Video visibility:** the authentic 2:50.20 candidate is publicly accessible as a repository
   asset on the Public GitHub feature branch and Draft PR #58, but it has not been uploaded to or
   made publicly visible on YouTube, Vimeo, or Youku and has not been linked or entered in Devpost.
   GitHub blob/raw access does not satisfy the official video-host/link requirement. This advances
   C18 only to `PARTIAL — LOCAL CANDIDATE`; C19 stays `OPEN`. Ask `support@devpost.com` whether
   unlisted hosting qualifies if Public is not feasible; current Rules only say publicly visible.
...
8. **English/accessibility:** the draft package and local candidate are English. Human-reviewed
   captions/transcript plus bounded accessibility, privacy, and media-rights evidence exist. English
   or translation is mandatory; captions remain a recommendation rather than an express Rules
   requirement. The entrant's chosen public export and final form still require review.
...
functioning-project candidate and synchronized English review packet, advancing C18/C20 only to
`PARTIAL`. The candidate is publicly accessible as a GitHub repository asset, but it has not been
uploaded to or made publicly visible on YouTube, Vimeo, or Youku, linked or entered in Devpost, or
submitted. It performs no registration, consent, form save, deployment, credential entry, live
provisioning, or tag/Release mutation.
