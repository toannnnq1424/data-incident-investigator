...
| C29 | [R §6](https://datahub.devpost.com/rules)                                                              | Stage 2 equal criteria: DataHub, execution, originality, usefulness, submission quality.                                                    | The submitted project combines the claim-mapped English story, Public app/repository, embedded authentic YouTube take, and five captioned fixture images. Real local DataHub OSS/MCP evidence exists and the source candidate adds a more judge-readable answer-first verdict and report-derived evidence path; the submission has not been judged.                                                | PARTIAL                                  | Phase 8.2–8.11             | Preserve the truthful matrix mapping and do not claim live-mode determinism, organizer acceptance, scoring, or that the UI source candidate is deployed.    |
...
durable entrant eligibility/IP attestation, organizer acceptance, or a prize result is claimed.
