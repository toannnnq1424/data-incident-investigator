...
| C09 | [R §4](https://datahub.devpost.com/rules)                                                              | Submitted repo uses Apache 2.0 visible at top/About.                                                                                        | Exact current main `ceaed0a3f5a277884bf03eb2605c3dd5f70b4afe` preserves canonical Apache-2.0 licensing; exact-main CI run `30232489891` / job `89873846528` is successful and GitHub detects `Apache-2.0`.                                                                                                                                                   | PASS                                    | Phase 8.4A complete      | Preserve exact license/main evidence through later work and recheck detection before submission.                                                         |
| C10 | [R §4](https://datahub.devpost.com/rules)                                                              | Public source repository with all necessary source/assets/instructions.                                                                     | GitHub is Public at exact current main `ceaed0a3f5a277884bf03eb2605c3dd5f70b4afe`, tree `0d38dd187fc6f3cd166d88287112f1dc3a46f867`, which integrates Phase 8.9. The running Cloud Run image remains separately bound to immutable source `3653cf6b…7fa4f`; later docs/media merges were not redeployed.                                                      | PASS                                    | Phase 8.4B complete      | Preserve and reverify Public access, reporting, exact-main evidence, and the separately governed external service through later work.                    |
...
Current matrix totals during Phase 8.9A repository-candidate preparation are
...
3. **Public repository:** C10 is `PASS`. The repository is Public, exact main is
   ...
   `0d38dd187fc6f3cd166d88287112f1dc3a46f867`, and Phase 8.9 is integrated. The running service
...
6. **Video visibility:** the authentic 2:50.20 source is public on merged `main`, and Phase 8.9A adds
   a synchronized male-voice derivative with the exact same video packets on its Public GitHub
   feature branch/Draft PR. Neither has been uploaded to or made publicly visible on YouTube, Vimeo,
...
`PARTIAL`. The assets are publicly accessible through the Public GitHub repository/feature PR, but
